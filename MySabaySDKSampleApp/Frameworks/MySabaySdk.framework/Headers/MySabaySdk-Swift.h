...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MySabaySdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10MySabaySdk31CountryCodePickerViewController") SWIFT_AVAILABILITY(ios,introduced=11.0)
...
@interface CountryCodePickerViewController (SWIFT_EXTENSION(MySabaySdk)) <UISearchResultsUpdating>
- (void)updateSearchResultsForSearchController:(UISearchController * _Nonnull)searchController;
@end


SWIFT_CLASS("_TtC10MySabaySdk13MSAccessToken")
...
SWIFT_CLASS("_TtC10MySabaySdk12MSMySabaySDK")
@interface MSMySabaySDK : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface MSMySabaySDK (SWIFT_EXTENSION(MySabaySdk)) <SKPaymentTransactionObserver>
...
@interface MSMySabaySDK (SWIFT_EXTENSION(MySabaySdk)) <SKProductsRequestDelegate>
...
SWIFT_CLASS("_TtC10MySabaySdk10MSOtpField")
@interface MSOtpField : UITextField
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC10MySabaySdk14MSOtpFieldView")
@interface MSOtpFieldView : UIView
- (void)awakeFromNib;
...
@interface MSOtpFieldView (SWIFT_EXTENSION(MySabaySdk)) <UITextFieldDelegate>
- (BOOL)textFieldShouldBeginEditing:(UITextField * _Nonnull)textField SWIFT_WARN_UNUSED_RESULT;
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC10MySabaySdk14MSRefreshToken")
@interface MSRefreshToken : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10MySabaySdk20PhoneNumberFormatter")
...
@interface PhoneNumberFormatter (SWIFT_EXTENSION(MySabaySdk))
...
SWIFT_CLASS("_TtC10MySabaySdk14PhoneNumberKit")
...
SWIFT_CLASS("_TtC10MySabaySdk20PhoneNumberTextField")
